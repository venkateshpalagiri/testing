...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<ErrorMessage> employeNotFoundException(EmployeeNotFoundException exception) {
		ErrorMessage message1 = new ErrorMessage(HttpStatus.NOT_FOUND, exception.getMessage());
